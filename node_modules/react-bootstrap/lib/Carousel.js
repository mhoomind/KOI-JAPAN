...
const Carousel = /*#__PURE__*/React.forwardRef(({
  ...
  return /*#__PURE__*/_jsxs(Component, {
    ...
    className: clsx(className, prefix, slide && 'slide', fade && `${prefix}-fade`, variant && `${prefix}-${variant}`),
      ...
      children: map(children, (child, index) => {
        ...
        return slide ? /*#__PURE__*/_jsx(TransitionWrapper, {
          ...
          children: (status, innerProps) => /*#__PURE__*/React.cloneElement(child, {
            ...innerProps,
            className: clsx(child.props.className, isActive && status !== 'entered' && orderClassName, (status === 'entered' || status === 'exiting') && 'active', (status === 'entering' || status === 'exiting') && directionalClassName)
          })
