...
const Modal = /*#__PURE__*/React.forwardRef(({
  ...
  const renderBackdrop = (0, _react.useCallback)(backdropProps => /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    ...backdropProps,
    className: (0, _clsx.default)(`${bsPrefix}-backdrop`, backdropClassName, !animation && 'show')
  ...
  const renderDialog = dialogProps => /*#__PURE__*/(0, _jsxRuntime.jsx)("div", {
    ...
    className: (0, _clsx.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`, !animation && 'show'),
