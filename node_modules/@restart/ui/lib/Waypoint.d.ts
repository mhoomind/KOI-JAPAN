...
import { type WaypointOptions, type WaypointEvent, type Position } from './useWaypoint.js';
export { Position };
 ...
 */
declare function Waypoint({ renderComponent, onPositionChange, ...options }: WaypointProps): React.ReactElement<unknown, string | React.JSXElementConstructor<any>>;
