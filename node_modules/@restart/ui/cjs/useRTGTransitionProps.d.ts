import type { TransitionProps as RTGTransitionProps, TransitionStatus } from 'react-transition-group/Transition.js';
...
export default function useRTGTransitionProps({ onEnter, onEntering, onEntered, onExit, onExiting, onExited, addEndListener, children, ...props }: TransitionProps): {
    ...
    nodeRef: import("react").RefObject<HTMLElement | null>;
    timeout: number | {
