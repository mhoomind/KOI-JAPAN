...
var _useTimeout = _interopRequireDefault(require("./useTimeout.js"));
var _useEventCallback = _interopRequireDefault(require("./useEventCallback.js"));
...
function useDebouncedCallback(fn, waitOrOptions) {
  ...
  const returnValueRef = (0, _react.useRef)(EMPTY);
  ...
  return (0, _react.useMemo)(() => {
    ...
    function leadingEdge(time) {
      ...
      if (!leading) {
        return returnValueRef.current === EMPTY ? undefined : returnValueRef.current;
      }
